...
interface UsernameModalProps {
  ...
  username: string;
  setUserame: React.Dispatch<React.SetStateAction<string>>;
}

const UsernameModal:React.FC<UsernameModalProps> = ({ showModal, setShowModal, username, setUserame }) => {

  const [inputValue, setInputValue] = useState(username);
    const [letterNum, setLetterNum] = useState(username.length);
            ...
            showModal && (
                ...
                >
                    ...
                    >
                        ...
                        <p className="font-[500] text-[1.125rem] text-gray-border mt-[0.5rem]">Enter a new username.</p>

                        <form className="text-left mt-[1.5rem]" onSubmit={handleSubmit}>
                            <label htmlFor="name" className="text-[1.125rem] text-custom-white font-[500]">Username</label>
