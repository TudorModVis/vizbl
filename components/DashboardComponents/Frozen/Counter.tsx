...
const Counter: React.FC<CounterProps> = ({ text, refetch }) => {
  ...
  return (
    <div className="flex gap-[1rem] items-center">
      <div className='w-[6rem] h-[1.75rem] text-[0.875rem] text-custom-white grid place-content-center border border-gray-border rounded-[0.15rem]'>
          {text}
      </div>

      <motion.div
                className="select-none cursor-pointer text-[0.75rem] font-[500] w-[3.25rem] h-[1.75rem] grid place-content-center border border-gray-border rounded-[0.15rem]"
                initial={{
